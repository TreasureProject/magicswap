...
export default function Index() {
  return (
    <div className="flex h-full flex-col items-center justify-center space-y-2 rounded-md border border-night-800 bg-[#131D2E] xl:flex-row xl:space-y-0 xl:space-x-2">
